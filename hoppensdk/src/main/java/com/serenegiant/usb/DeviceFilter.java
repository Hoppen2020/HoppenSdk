...
public final class DeviceFilter {
	...
	public DeviceFilter(final int vid, final int pid, final int clasz, final int subclass,
                        final int protocol, final String manufacturer, final String product, final String serialNum , final int type) {
	...
	public DeviceFilter(final int vid, final int pid, final int clasz, final int subclass,
		...
		this.deviceType = deviceType== DeviceType.DEVICE_TYPE_MCU?
				DeviceType.DEVICE_TYPE_MCU:
				deviceType== DeviceType.DEVICE_TYPE_CAMARE?
						DeviceType.DEVICE_TYPE_CAMARE:
